--[[
	Axon · Modules/Explorer
	The main explorer interface (instance tree, selection, context menus).

	Uses the shared globals `nodes` and `selection` (established in src/init.lua)
	so the Explorer and the rest of the suite operate on the same tree/selection.
]]
